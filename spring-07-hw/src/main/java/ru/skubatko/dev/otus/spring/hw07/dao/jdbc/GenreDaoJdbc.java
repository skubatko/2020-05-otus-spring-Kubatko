...
public class GenreDaoJdbc implements GenreDao {
    ...
    public Genre findById(long id) {
        ...
        return jdbc.queryForObject("select * from genres where id = :id", params, this::genreRowMapper);
    }

    @Override
    public List<Genre> findAll() {
        return jdbc.query("select * from genres", this::genreRowMapper);
    }
    ...
    @Override
    public long count() {
        return jdbc.queryForObject("select count(*) from genres", Collections.emptyMap(), Long.class);
    }
