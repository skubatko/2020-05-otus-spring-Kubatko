package ru.skubatko.dev.otus.spring.hw31.service;

import ru.skubatko.dev.otus.spring.hw31.domain.Author;
import ru.skubatko.dev.otus.spring.hw31.domain.Book;
import ru.skubatko.dev.otus.spring.hw31.domain.Comment;
import ru.skubatko.dev.otus.spring.hw31.domain.Genre;
import ru.skubatko.dev.otus.spring.hw31.dto.BookDto;
import ru.skubatko.dev.otus.spring.hw31.exception.library.service.AuthorNotFoundLibraryServiceException;
import ru.skubatko.dev.otus.spring.hw31.exception.library.service.BookAlreadyExistsLibraryServiceException;
import ru.skubatko.dev.otus.spring.hw31.exception.library.service.BookNotFoundLibraryServiceException;
import ru.skubatko.dev.otus.spring.hw31.exception.library.service.CommentNotFoundLibraryServiceException;
import ru.skubatko.dev.otus.spring.hw31.exception.library.service.GenreNotFoundLibraryServiceException;
import ru.skubatko.dev.otus.spring.hw31.repository.AuthorRepository;
import ru.skubatko.dev.otus.spring.hw31.repository.BookRepository;
import ru.skubatko.dev.otus.spring.hw31.repository.CommentRepository;
import ru.skubatko.dev.otus.spring.hw31.repository.GenreRepository;
